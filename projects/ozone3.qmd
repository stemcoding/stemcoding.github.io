...
If you have the desktop version of Excel then create the plot like normal but then click the plot and change the type to "combo" and select one of the data series to be the "Secondary Axis" as described in [this tutorial from microsoft](https://support.microsoft.com/en-us/office/excelexp/add-or-remove-a-secondary-axis-in-a-chart-in-excel)

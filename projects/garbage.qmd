...
<iframe class="p5-lazy-iframe" width="100%" height="445" data-src="https://editor.p5js.org/ChrisOrban/full/K9YEn7ru-" src="about:blank"></iframe>

<script>
(function() {
  function initObserver() {
    const iframes = document.querySelectorAll(".p5-lazy-iframe");
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        ...
        if (entry.isIntersecting) {
          ...
          // Set to about:blank to stop p5.js sketch execution and free CPU
      ...
      rootMargin: "100px" // Load slightly before it comes into view for a smoother experience
    });

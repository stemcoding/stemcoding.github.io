...
The simulation above contains a mathematical model for an ocean gyre that comes from [this research paper](https://doi.org/10.1016/j.physd.2005.10.007). The little white dots are supposed to be pieces of garbage. The black arrows show the direction of ocean currents.

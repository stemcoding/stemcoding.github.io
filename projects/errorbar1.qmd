...
<b>Task:</b> Replicate either plot using Google Sheets or Excel with this [sample data](sample.csv)
...
## Up next: [Are my error bars big or small?](errorbar2.html)

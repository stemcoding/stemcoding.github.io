---
title: "Indexes as a way to explain health risk"
image: ../img/hazardousAQI.png
categories:
    - Atmospheric Science
...
![](../img/hazardousAQI.png){height=300 fig-align="center"}
...
The AQI solves this problem like this by deciding on a danger range for each of the scientific measurements, and calculating an AQI for each item on the list -- specifically you have AQI<sub>PM2.5</sub> ,  AQI<sub>PM10</sub>, AQI<sub>O3</sub>, AQI<sub>CO</sub>, AQI<sub>SO2</sub>, and AQI<sub>NO2</sub>.
...
where the MAX() function used above only returns the largest quantity. There is actually a spreadsheet function called MAX that works like this which you can find in both [Sheets](https://support.google.com/docs/answer/3094013?hl=en) and [Excel](https://support.microsoft.com/en-us/excel/functions/max-function).

For more information about how AQI is determined, consult [this EPA document](technical-assistance-document-for-the-reporting-of-daily-air-quailty.pdf)

## Task: Example data 

Here is some data from a fictional town with poor air quality called Coughington, USA. There is a week of data and the AQI for each source of poor air quality is listed for each day.
<center>
[Click here to download Air Quality data for Coughington, USA](coughingtonUSA.csv)
</center>

Load this data into a spreadsheet and use the MAX function to fill in the column under "Overall AQI".

Which day of the week has the worst air quality according to the Overall AQI? Is there another day that you might argue has worse air quality, but it does not end up being the worst day according to the way that the Overall AQI is designed?
...
<iframe width=700 height=394 src="https://www.youtube.com/embed/Q7HvGKvTdUM?si=_R2xcL07d__rpQjs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
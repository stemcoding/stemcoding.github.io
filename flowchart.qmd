...
format:
  html:
    mermaid:
      theme: forest
    include-after-body: projects/cc-badge.html
---

Some activities have an intended sequence, while others stand alone. Below are the activities that have an intended sequence.

## Data science

### Error bar activities

```{mermaid}
flowchart LR
  A[Why we love error bars!] --> B[Are my error bars big or small?]
  click A "projects/errorbar1.html" "Why we love error bars!"
  B --> C[Error bars and animal sizes]
  click B "projects/errorbar2.html" "Are my error bars big or small?"
  click C "projects/errorbar3.html" "Error bars and animal sizes"
```
...
```{mermaid}
flowchart LR
  A[Ozone Recovery Part 1] --> B[Ozone Recovery Part 2]
  click A "projects/ozone1.html" "Ozone Recovery (Part 1)"
  B --> C[Ozone Recovery Part 3]
  click B "projects/ozone2.html" "Ozone Recovery (Part 2)"
  click C "projects/ozone3.html" "Ozone Recovery (Part 3)"
```
...
```{mermaid}
flowchart LR
  A[Object Tracker Part 1. Track the Object] --> B[Object Tracker Part 2. Analyze Height vs Time] 
  click A "projects/objecttracker.html" "Object Tracker Part 1. Track the Object"
  B --> C[Object Tracker Part 3. Analyze Velocity vs Time]
  click B "projects/objecttracker.html" "Object Tracker Part 2. Analyze Height vs Time"
  click C "projects/objecttracker.html" "Object Tracker Part 3. Analyze Velocity vs Time"
```

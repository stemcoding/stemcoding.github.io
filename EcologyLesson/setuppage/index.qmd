...
* Download the Installer
	* Install LibreOffice by going to [the installation page](https://www.libreoffice.org/download/). The version for Windows should automatically be selected. Click Download Version X.X.X (whichever is the most recent version). You will go to a page that asks about a donation, but you don’t need to make one. Your download should begin automatically.
* Install LibreOffice
...
* Download the Installer
	* Install LibreOffice by going to [the installation page](https://www.libreoffice.org/download/). The version for Mac should automatically be selected. Click Download Version X.X.X (whichever is the most recent version). You will go to a page that asks about a donation, but you don’t need to make one. Your download should begin automatically.
* Install LibreOffice
* Once the installer is downloaded, double click on it and LibreOffice should install

### Linux
* Download the Installer
	* Install LibreOffice by going to [the installation page](https://www.libreoffice.org/download/). The version for Linux should automatically be selected. Click Download Version X.X.X (whichever is the most recent version). You will go to a page that asks about a donation, but you don’t need to make one. Your download should begin automatically.
* Install LibreOffice
* Once the installer is downloaded, double click on it and LibreOffice should install.

[Continue to the first lesson.](../intro/index.qmd)

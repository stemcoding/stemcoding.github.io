...
| 00:00 | [Introduction](../Intro/index.qmd) | What are basic principles for using spreadsheets for good data organization? |
| 00:18 | [Formatting data tables in spreadsheets](../formattingtables/index.qmd) | How do we format data in spreadsheets for effective data use? |
| 00:53 | [Formatting problems](../formattingproblems/index.qmd) | What are some common challenges with formatting data in spreadsheets and how can we avoid them? |
| 01:13 | [Dates as data](../datesasdata/index.qmd) | What are good approaches for handling dates in spreadsheets? |
| 01:26 | [Quality Control](../qualitycontrol/index.qmd) | How can we carry out basic quality control and quality assurance in spreadsheets? |
| 01:46 | [Exporting Data](../exporting/index.qmd) | How can we export data from spreadsheets in a way that is useful for downstream applications? |
| 01:56 | Finish | |

...
function readCookiesJSON() {
    ...
    if (Cookies.get('vaxCookie') == undefined) initCookiesJSON();
...
function setCookies() {
    ...
    if (difficultyString == "easy") {
        if (speed) {
            if (Cookies.get('vaxEasyHiScoreRT') < proportionSaved) Cookies.set('vaxEasyHiScoreRT', proportionSaved)
            if (proportionSaved >= easyBar) Cookies.set('vaxEasyCompletion', 'true')
        }
        else {
            if (Cookies.get('vaxEasyHiScore') < proportionSaved) Cookies.set('vaxEasyHiScore', proportionSaved)
            if (proportionSaved >= easyBar) Cookies.set('vaxEasyCompletion', 'true')
        }
    }
    ...
    if (difficultyString == "medium") {
        if (speed) {
            if (Cookies.get('vaxMediumHiScoreRT') < proportionSaved) Cookies.set('vaxMediumHiScoreRT', proportionSaved)
            if (proportionSaved >= mediumBar) Cookies.set('vaxMediumCompletion', 'true')
        }
        else {
            if (Cookies.get('vaxMediumHiScore') < proportionSaved) Cookies.set('vaxMediumHiScore', proportionSaved)
            if (proportionSaved >= mediumBar) Cookies.set('vaxMediumCompletion', 'true')
        }
    }
    ...
    if (difficultyString == "hard") {
        if (speed) {
            if (Cookies.get('vaxHardHiScoreRT') < proportionSaved) Cookies.set('vaxHardHiScoreRT', proportionSaved)
            if (proportionSaved >= hardBar) Cookies.set('vaxHardCompletion', 'true')
        }
        else {
            if (Cookies.get('vaxHardHiScore') < proportionSaved) Cookies.set('vaxHardHiScore', proportionSaved)
            if (proportionSaved >= hardBar) Cookies.set('vaxHardCompletion', 'true')
        }
    }
}
...
function writeCookiesJSON() {
    ...
    Cookies.remove('vaxCookie')
    Cookies.set('vaxCookie', JSON.stringify(newCookie), { expires: 365, path: '/' })
}
